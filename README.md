...
4. Nakon uključivanja opcije <code>Developer mode</code>, u gornjem lijevom uglu odabrati opciju <code>Load unpacked</code> i odabrati prethodno preuzeti folder (<b>potrebno je otvoriti folder ekstenzije i tada klikunti na dugme select</b>). Upustvo za učitavanje ekstenzija je dostupno i <a href="https://developer.chrome.com/docs/extensions/get-started/tutorial/hello-world#load-unpacked">na ovom linku</a>.



Ekstenzija je spremna i nalazi se pored polja za pretragu (moguće je pronaći je klikom na ikonicu <img width=16 height=16 src="./assets/chrome-extension-icon.png" alt="u obliku puzle">). Ukoliko se kartice predmeta ne prikažu otvaranjem ekstenzije potrebno je osvježiti stranicu i pokušati ponovo.

<img src="./assets/screenshot.png" alt="Screenshot upotrebe ekstenzije">

# Video demonstracija
[![FTN Canvas Plus Plus demonstracija](https://img.youtube.com/vi/vn86I_mD5IA/0.jpg)](https://www.youtube.com/watch?v=vn86I_mD5IA)
